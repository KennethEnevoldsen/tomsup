...
df = read_csv(here("CogSci19_MatchingPennies_TOM_data_updated.csv"))
...
df %>% 
  ...
  ggplot(aes(x=trial)) +
        ...
        scale_colour_manual(values=c('purple', 'orange', 'green', 'red', 'blue'),
                          labels = c('Level 0', 'Level 1', 'Level 2', 'Level 3', 'Level 4'), name = "Estimated player level") +
        labs(y = 'Probability of player level', x = 'Trial') +
        theme_minimal() + 
        theme(axis.line = element_line(colour = "grey", size = 0.5),
              axis.ticks =element_line(colour = "grey", size = 0.5),
              axis.title = element_text(color="black", size=10, face="bold"),
