...
def test_tutorial():
    ...
    results = group.compete(p_matrix=penny, n_rounds=4,
                            n_sim=2, save_history=True)
    ...
    group.plot_tom_op_estimate(agent0="1-TOM", agent1="2-TOM", agent=1, estimate="volatility", level=1, plot="mean", show=False)

    # plot 2-ToM estimate of its opponent's bias while believing the opponent to be level 1.
    group.plot_tom_op_estimate(agent0="1-TOM", agent1="2-TOM", agent=1, estimate="bias", level=1, plot="mean", show=False)